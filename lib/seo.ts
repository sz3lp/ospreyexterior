...
export const buildLocalBusinessJsonLd = (city?: City) => {
  ...
  return {
    ...
    image: 'https://ospreyexterior.com/assets/hero.jpg',
    '@id': 'https://ospreyexterior.com',
...
export const buildArticleJsonLd = (post: Post) => ({
  ...
  image: post.featured_image || 'https://ospreyexterior.com/assets/hero.jpg',
  author: {
    '@type': 'Organization',
    name: siteName
  },
  publisher: {
    ...
    logo: {
      '@type': 'ImageObject',
      url: 'https://ospreyexterior.com/favicon.png'
    }
  },
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': `https://ospreyexterior.com/blog/${post.slug}`
  }
});
